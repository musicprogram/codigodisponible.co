...
$( document ).ready(function() {
    ...
    $('ul#slide-out li a').click(function(){
      ...
      if(page == 'juanhenao'){
        ...
        $('#img_profile').html('<div class="card-avatar blue-grey darken-2"> <a href="https://s3.us-east-2.amazonaws.com/codigodigital.tk/juan+henao+rendon+HV-compress.pdf"> <img src="https://image.ibb.co/bPj8Jb/marc.jpg" id="profile"> </a> </div>'); 
